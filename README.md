...
Analýza rádiových presetov a pokrytia MeshCore repeaterov v SK, AT, HU, CZ, DE, SI, PL a IT, postavená na verejných dátach z [map.meshcore.io](https://map.meshcore.io) a [api.meshcore.nz](https://api.meshcore.nz).
