...
**Community-official preset:** the mandatory "Netherlands" preset `869.618/62.5/SF7/CR5` — [localmesh.nl](https://www.localmesh.nl/en/meshcore-repeater-setup/) repeatedly stresses that everyone must use it. Match with map data: ✅ yes ({{PCT}}% — the shortfall is unmigrated nodes).
